...
public class HttpParser {
  ...
  private Map<String, Object> headers, params;
  private int[] ver;
  ...
  public HttpRequest parseRequest() throws IOException {
    ...
    if (initial == null || initial.length() == 0) return new HttpRequest(0, null, null, null, null, null);
    if (Character.isWhitespace(initial.charAt(0))) {
      // starting whitespace, return bad request
      return new HttpRequest(400, null, null, null, null, null);
    }
    ...
    return new HttpRequest(ret, method, url, headers, params, ver);
  }
